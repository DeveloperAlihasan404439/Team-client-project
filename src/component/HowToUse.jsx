          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:pb-10">
            ...
            <div className="flex flex-col items-start gap-2 justify-start mt-2 md:mt-8">
              ...
              <p className="text-sm ">
                ...
                is your go-to. Insert your generated email, receive verification
                emails, and proceed hassle-free.
              </p>
            </div>
            <div className="flex flex-col items-start gap-2 justify-start mt-2 md:mt-8">
              <Lottie
            ...
            <div className="flex flex-col items-start gap-2 justify-start mt-2 md:mt-8">
              ...
              <p className="text-sm ">
                Swifty Mail is designed for ease. No lengthy sign-up processes,
                no commitments. Just the right tool for your on-the-go privacy
                needs. Experience the simplicity, security, and convenience of
