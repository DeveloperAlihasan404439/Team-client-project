      ...
      >
        ...
        <div className="lg:w-[50%] flex flex-col justify-center items-center gap-4">
          ...
          <p className=" md:text-lg ">
            ...
            reliable cloud storage solution. Seamlessly store, access, and share
            your files with ease, ensuring your data is always secure and
          ...
          <aside>
          <Lottie className='h-20  hidden md:inline ' animationData={img2} loop={true} />
          </aside>
