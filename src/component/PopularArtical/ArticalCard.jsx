...
const ArticalCard = ({data}) => {
    ...
    return(
     ...
     whileHover={{scale:1.02 ,  transition: { duration: 0.3 }}}
      ...
      >
             <Link to={`/articledetails/${_id}`} className="flex cursor-pointer flex-col md:flex-row  group justify-between rounded-xl bg-white  items-center  drop-shadow-md duration-200   p-5 lg:h-44 md:h-52 font-inter gap-5">
