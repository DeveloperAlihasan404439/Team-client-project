...
const ErrorPage = () => {
    return (
        <div className="flex h-[100dvh] pt-20 lg:pt-40  bg-[#EEEEEE] flex-col md:flex-row text-center md:text-center p-6 max-w-7xl gap-20 mx-auto justify-center items-center ">
            <section className=" ">
            <Lottie className="w-96 drop-shadow" animationData={error} loop={true} />
            </section>
            <section className=" " >
                <h1 className="text-5xl drop-shadow text-[#FF5733] font-bold"> 404 - Page Not Found</h1>
