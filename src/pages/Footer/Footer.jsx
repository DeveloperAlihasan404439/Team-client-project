  ...
  return (
    ...
    >
     ...
     <motion.div
      ...
      <aside className='pr-6 mx-auto  flex flex-col justify-end items-center text-end  lg:border-r-2 border-[#144248]  col-span-2 md:col-span-1 '>
        <img className='h-8 ml-6'  src={logo} alt="" />
        <p className='text-[10px] ml-14 text-right'>Copyright © 2024 - All rights reserved</p>
      </aside> 
      <nav className='pr-6  mx-auto  border-r-2 border-[#144248] '>
      ...
      <div className='pr-6 mx-auto   border-r-2 border-[#144248] '>
        <h1 className="text-xl font-semibold">Contact Us</h1>
        <p>Email: support@acme.com</p>
