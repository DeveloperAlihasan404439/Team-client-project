...
const WhyUS = () => {
    ...
    return (
      ...
      className=" mt-20 relative  ">
                ...
                <section className='max-w-7xl shadow-md rounded-xl border-t-2 bg-[#EEEEEE]  p-6 mx-auto text-center z-90 '>
      <header >
           ...
           <body className='grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-6  mt-10'>
            <aside className='text-center flex flex-col justify-center items-center lg:gap-4 '>
 ...
 Swifty Mail prioritizes your privacy by providing disposable and secure temporary email addresses. Protect your personal information and enjoy a worry-free online experience.</p>
            ...
            <Lottie className=' lg:col-span-2 lg:row-span-2'  animationData={img} loop={true} />
            <aside className='text-center flex flex-col justify-center items-center gap-4 '>
            <Lottie className='h-28 col-span-2 row-span-2'  animationData={img2} loop={true} />
