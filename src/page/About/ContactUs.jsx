      ...
      <div className="hero ">
        ...
        <div className="hero-content items-start  lg:p-12 justify-start flex flex-col gap-16 lg:flex-row  ">
          <section className="lg:w-1/2">
            <Lottie
              className="h-80 w-full lg:col-span-2 lg:row-span-2"
            ...
            <div className=" p-4 rounded-xl backdrop-blur">
              <h1 className="text-2xl backdrop-blur font-semibold dark:text-slate-200">
                ...
                Experience: A Guide to Optimal Output
              </h1>
              <BestOutput
                title={"Explore Customization Features:"}
                description={
                  "Personalize your temporary email experience by exploring customization options. Tailor settings to match your preferences, ensuring seamless integration with your online activities."
                }
              ></BestOutput>
              <BestOutput
                title={"Efficient Email Management:"}
                description={
                  "Learn the ins and outs of managing your temporary emails effortlessly. From creation to disposal, understand the features that make email management a breeze."
                }
              ></BestOutput>
              <BestOutput
                title={"Advanced Verification Techniques:"}
                description={
                  "Dive into advanced techniques for efficient email verification. Discover how Swifty Mail simplifies the verification process, saving you time and ensuring you never miss an important confirmation."
                }
              ></BestOutput>
              <BestOutput
                title={"Integrate with Third-Party Services:"}
                description={
                  "Uncover the potential of integrating Swifty Mail with various third-party services. Explore how our platform seamlessly collaborates with other tools to enhance your overall online experience."
                }
              ></BestOutput>
              <BestOutput
                title={"Stay Informed with Notifications:"}
                description={
                  "Optimize your usage by staying informed. Learn how to enable notifications, keeping you updated on incoming emails, verifications, and important activities without missing a beat."
                }
              ></BestOutput>
              <BestOutput
                title={"Mastering Privacy Settings:"}
                description={
                  "Understand the nuances of privacy settings to fortify your online presence. Swifty Mail offers robust privacy features; discover how to leverage them effectively for enhanced security."
                }
              ></BestOutput>
            </div>
          </section>
