    ...
    <div>
      ...
      >
        <section>
          ...
          <h3 className="py-2 text-lg font-bold">Interpretation</h3>
          <p className="py-1">
          ...
          <h3 className="py-2 text-lg font-bold">Definitions</h3>
          ...
          <ul className="flex gap-3 items-center mb-5 flex-wrap">
            <li className="py-[2px] rounded bg-[#144248] px-5 text-[#EEE]">
              Google
            </li>
            <li className="py-[2px] rounded bg-[#144248] px-5 text-[#EEE]">
              Facebook
          ...
          <h3 className="py-2 text-md font-bold">Types of Data Collected</h3>
          <h4>Personal Data</h4>
          <p className="py-1">
          ...
          <h3 className="py-2 text-md font-bold">Use of Your Personal Data</h3>
          ...
          <h3>Use of Yourpy-2 Personal Data</h3>
          <p className="py-1">
          ...
          <h3 className="py-2 text-md font-bold">Delete Your Personal Data</h3>
          <p className="py-1">
          ...
          <h3>Security ofpy-2 Your Personal Data</h3>
          <p className="py-1">
          ...
          import {motion} from 'framer-motion';
          <h2 className="py-4 text-lg font-bold">Children's Privacy</h2>
          <p className="py-1">
          ...
          <h2 className="py-4 text-lg font-bold">Links to Other Websites</h2>
          <p className="py-1">
          ...
          <h2 className="py-4 text-lg font-bold">Contact Us</h2>
          <p className="py-1">
          ...
          <ul>
            <li className="py-1">
              <p className="py-1">By email : zzayedghost@gmail.com</p>
            </li>
            <li className="py-1">
              <p className="py-1">By phone number: 01902320296</p>
            </li>
          </ul>
        </section>
      </motion.div>
