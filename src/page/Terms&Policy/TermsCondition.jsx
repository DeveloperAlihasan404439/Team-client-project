  ...
  return (
    ...
    >
      ...
      <p>
        ...
        of FuncitonFusion's Website, located at https://temp-mail.org/en/.
      </p>
      <p>
        By accessing this website, we assume you accept these terms and
        conditions. Do not continue to use{" "}
        <span className="text-[#019D90] font-semibold">Swifty Mail</span> if you
      ...
      <p>
        ...
        FuncitonFusion,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, FuncitonFusion shall not be liable
      ...
      <p>
        FuncitonFusion reserves the right to monitor all Comments and to remove
